...
static SessionFactory sessionFactory = new MetadataSources( registry ).buildMetadata().buildSessionFactory();
	...
	public static void main(String[] args) {
		 ...
		 Cliente cliente1 = new Cliente (0,"carlos","avila","chavez");
		 Cliente cliente2 = new Cliente (0,"miguel","avila","mosquera");
		 Cliente cliente3 = new Cliente (0,"nicol","avila","mosquera");
         ...
         Pais pais2 = new Pais (0,"Chil");
         Pais pais3 = new Pais (0,"Italia");
